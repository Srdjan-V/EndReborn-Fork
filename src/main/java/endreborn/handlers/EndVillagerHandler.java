...
public class EndVillagerHandler {
    ...
    public static void initIEVillagerTrades() {
        ...
        overworld_explorer.addTrade(1,
                ...
                new ItemstackForEmerald(new ItemStack(ItemInit.INGOT_WOLFRAMIUM, 1, 0),
        ...
        end_explorer.addTrade(1,
                ...
                new ItemstackForEmerald(new ItemStack(ItemInit.END_ESSENCE, 3, 0),
                ...
                new ItemstackForEmerald(new ItemStack(ItemInit.CHORUS_SOUP, 3, 0),
                        new EntityVillager.PriceInfo(-2, -1)));
    }
