...
public class ChestsHandler {
    ...
    private static final List<String> CHEST_TABLES = ImmutableList.of("abandoned_mineshaft", "desert_pyramid",
    ...
    public static void lootLoad(LootTableLoadEvent evt) {
        ...
        if ((ConfigsHandler.GENERAL.chestLoot && name.startsWith(chests_prefix) &&
