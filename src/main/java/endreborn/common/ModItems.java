...
public final class ModItems {
    ...
    // Materials
    public static final ToolMaterial TOOL_ENDORIUM = EnumHelper.addToolMaterial("tool_endorium", 4, 1024, 6.5F, 4.0F,
            13);
    public static final ToolMaterial TOOL_MAGNIFIER = EnumHelper.addToolMaterial("tool_magnifier", 4, 256, 5.5F, 1.0F,
            13);
    ...
    public static final ToolMaterial TOOL_WOLFRAMIUM = EnumHelper.addToolMaterial("tool_wolframium", 3, 512, 5.5F, 2.5F,
            11);
    public static final ArmorMaterial ARMOUR_OBSIDIAN = EnumHelper.addArmorMaterial("armour_obsidian",
            Reference.MODID + ":obsidian", 33, new int[] { 4, 7, 8, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.0F);
    public static final ArmorMaterial ARMOUR_HELMET = EnumHelper.addArmorMaterial("armour_helmet",
            Reference.MODID + ":helmet", 33, new int[] { 4, 7, 8, 4 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 3.0F);
    public static final ArmorMaterial ARMOUR_DRAGON = EnumHelper.addArmorMaterial("armour_dragon",
            Reference.MODID + ":dragon", 44, new int[] { 6, 9, 10, 6 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON, 5.0F);
    public static final ArmorMaterial ARMOUR_HELMET_D = EnumHelper.addArmorMaterial("armour_helmet_d",
            Reference.MODID + ":dragon_helmet", 44, new int[] { 6, 9, 10, 6 }, 10, SoundEvents.ITEM_ARMOR_EQUIP_IRON,
            5.0F);
    ...
    // Armors
    public static final Item CHESTPLATE_OBSIDIAN = new ArmourBase("armour_chestplate_obsidian", ARMOUR_OBSIDIAN, 1,
            EntityEquipmentSlot.CHEST);
    public static final Item LEGGINGS_OBSIDIAN = new ArmourBase("armour_leggings_obsidian", ARMOUR_OBSIDIAN, 2,
            EntityEquipmentSlot.LEGS);
    public static final Item BOOTS_OBSIDIAN = new ArmourBase("armour_boots_obsidian", ARMOUR_OBSIDIAN, 1,
            EntityEquipmentSlot.FEET);
    public static final Item HELMET_OBSIDIAN = new ArmourModel("armour_helmet_helmet", ARMOUR_HELMET, 1,
            EntityEquipmentSlot.HEAD);
    public static final Item CHESTPLATE_DRAGON = new ArmourBase("armour_chestplate_dragon", ARMOUR_DRAGON, 1,
            EntityEquipmentSlot.CHEST);
    public static final Item LEGGINGS_DRAGON = new ArmourBase("armour_leggings_dragon", ARMOUR_DRAGON, 2,
            EntityEquipmentSlot.LEGS);
    public static final Item BOOTS_DRAGON = new ArmourBase("armour_boots_dragon", ARMOUR_DRAGON, 1,
            EntityEquipmentSlot.FEET);
    public static final Item HELMET_DRAGON = new ArmourDModel("armour_helmet_dragon", ARMOUR_HELMET_D, 1,
            EntityEquipmentSlot.HEAD);
