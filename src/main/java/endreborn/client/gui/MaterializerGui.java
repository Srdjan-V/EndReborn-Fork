...
public class MaterializerGui extends GuiContainer {
    ...
    public MaterializerGui(InventoryPlayer player, MaterializerTile tileEntity) {
        super(new MaterializerContainer(player, tileEntity));
    ...
    protected void drawGuiContainerBackgroundLayer(float ticks, int x, int y) {
        ...
        /*
         * if (TileMaterializer.isBurning(tileEntity)) {
