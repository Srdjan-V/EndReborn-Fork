...
import endreborn.client.entity.layer.LayerChronologist;
...
public class RenderChronologist extends RenderLiving<EntityChronologist> {
    ...
    public static final ResourceLocation TEXTURES = new ResourceLocation(
            Reference.MODID + ":textures/entity/chronologist.png");
    ...
    @Override
    protected void applyRotations(EntityChronologist entityLiving, float p_77043_2_, float rotationYaw,
                                  float partialTicks) {
