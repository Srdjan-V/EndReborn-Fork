...
public class OreGen implements IWorldGenerator {
    ...
    public OreGen() {
        ore_end_essence = new WorldGenMinable(BlockInit.ESSENCE_ORE.getDefaultState(), 9,
                BlockMatcher.forBlock(Blocks.OBSIDIAN));
        ore_over_essence = new WorldGenMinable(BlockInit.ESSENCE_ORE.getDefaultState(), 9,
                BlockMatcher.forBlock(Blocks.OBSIDIAN));
        ore_wolframium = new WorldGenMinable(BlockInit.ORE_WOLFRAMIUM.getDefaultState(), 4,
                BlockMatcher.forBlock(Blocks.STONE));
        lormyte = new WorldGenLormyte();
        end_magma = new WorldGenMinable(BlockInit.BLOCK_END_MAGMA.getDefaultState(), 30,
                BlockMatcher.forBlock(Blocks.END_STONE));
        end_entropy = new WorldGenMinable(BlockInit.ENTROPY_END_STONE.getDefaultState(), 10,
                BlockMatcher.forBlock(Blocks.END_STONE));
    }
    ...
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
        ...
        switch (world.provider.getDimension()) {
            ...
            case 0:
                if (ConfigsHandler.GENERAL.spawnEssenceOre) {
                    runGenerator(ore_over_essence, world, random, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.essenceRareOver, 0, 256);
                }
                if (ConfigsHandler.GENERAL.spawnWolframiumOre) {
                    runGenerator(ore_wolframium, world, random, chunkX, chunkZ, ConfigsHandler.BALANCE.wolframiumRare,
                            0, 48);
                }
            ...
            case 1:
                if (ConfigsHandler.GENERAL.spawnEssenceOre) {
                    runGenerator(ore_end_essence, world, random, chunkX, chunkZ, ConfigsHandler.BALANCE.essenceRareEnd,
                            0, 256);
                }
