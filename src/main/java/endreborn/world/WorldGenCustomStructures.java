            ...
            case 1:
                if (ConfigsHandler.GENERAL.spawnEndRuines) {
                    generateStructure2(new WorldGenStructure("end_deco"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.ruinesRare, Blocks.END_STONE, BiomeEnd.class);
                }
                break;
            ...
            case 0:
                if (ConfigsHandler.GENERAL.spawnEndIsland) {
                    generateStructure(new WorldGenStructure("end_island"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.islandRare, Blocks.AIR, BiomePlains.class);
                    generateStructure(new WorldGenStructure("end_island"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.islandRare, Blocks.AIR, BiomeDesert.class);
                    generateStructure(new WorldGenStructure("end_island"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.islandRare, Blocks.AIR, BiomeOcean.class);
                    generateStructure(new WorldGenStructure("end_island"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.islandRare, Blocks.AIR, BiomeSavanna.class);
                }
                if (ConfigsHandler.GENERAL.spawnObservatory) {
                    generateStructure3(new WorldGenStructure("observ"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.obsRare, Blocks.STONE, BiomeSwamp.class);
                    generateStructure3(new WorldGenStructure("observ"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.obsRare, Blocks.STONE, BiomeForest.class);
                    generateStructure3(new WorldGenStructure("observ"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.obsRare, Blocks.STONE, BiomeDesert.class);
                    generateStructure3(new WorldGenStructure("observ"), world, rand, chunkX, chunkZ,
                            ConfigsHandler.BALANCE.obsRare, Blocks.STONE, BiomeOcean.class);
                }
