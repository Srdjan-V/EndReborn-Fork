...
public class PlayerParticlePacket extends ParticlePacket {
    ...
    public PlayerParticlePacket(boolean remove, String id, int renderIterations, @Nullable EnumParticleTypes particleType) {
    ...
    public enum Handler implements IMessageHandler<PlayerParticlePacket, IMessage> {
        ...
        @Override public IMessage onMessage(PlayerParticlePacket message, MessageContext ctx) {
