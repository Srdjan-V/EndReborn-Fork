...
public class EndBiomesConfig extends ReloadableServerSideConfig<Map<String, BiomeSchema>> {
    ...
    @Override protected Map<String, BiomeSchema> getDefaultData() {
    ...
    @Override protected @Nullable Map<String, BiomeSchema> getLoadedData() {
    ...
    @Override protected Map<String, BiomeSchema> dataMerger(
